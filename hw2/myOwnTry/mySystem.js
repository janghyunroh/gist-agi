...
// 1. 60초 동안 API를 이용해 보드와 상호작용

// 1) Rule Probing: 상호작용하며 특정 규칙 감지. 
...
// 전략의 기본적인 접근법은 MCTS.
// MCTS이지만 10초 제한 시간이 있으므로 동적으로 활용

// 또한 API의 평가 함수에 부족함을 느끼고, HW1에서 자체적으로 개발한 평가 함수를 사용해보기로 결정. 
// MCTS에 평가 함수 적용할 시 주의점: 게임 끝 보상은 점수 보상보다 훨씬 크게 잡기
